    ...
    <div className="min-h-screen flex items-center justify-center bg-[#111113] text-[#f0f0f0] px-4 py-8">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-[#1a1a1e] border border-[#2e2e35] rounded-2xl px-6 py-7">
          <h2 className="text-lg font-medium mb-5 text-[#f0f0f0]">Regisztráció</h2>

          {/* Full Name */}
          <label htmlFor="fullname" className="block text-[13px] text-[#888] mb-1.5">
            Teljes név
          </label>
          <input
            type="text"
            id="fullname"
            placeholder="pl. Kovács Máté"
          ...
          <input
            type="text"
            id="username"
            placeholder="pl. mate.kovacs"
            className="w-full px-3.5 py-3 rounded-lg border border-[#2e2e35] bg-[#111113] text-[#f0f0f0] text-[15px] outline-none mb-3 placeholder-[#555] transition-colors duration-200 focus:border-[#8b80e0]"
          />

          {/* Email */}
          <label htmlFor="email" className="block text-[13px] text-[#888] mb-1.5">
            E-mail cím
          </label>
          <input
            type="email"
          ...
          {/* Confirm Password */}
          <label htmlFor="password-confirm" className="block text-[13px] text-[#888] mb-1.5">
            Jelszó megerősítése
          </label>
          <div className="relative mb-5">
            ...
            <button
              ...
              aria-label="Jelszó megerősítésének megjelenítése"
              className="absolute right-3 top-1/2 -translate-y-1/2 text-lg text-[#666] bg-transparent border-none cursor-pointer p-0"
            >
              <i className={showPasswordConfirm ? "ti ti-eye-off" : "ti ti-eye"} />
            </button>
          </div>
        ...
        <div className="text-center mt-5 text-sm text-[#888]">
          Már van fiókod?{" "}
          <a href="/login" className="text-[#8b80e0] font-medium no-underline hover:underline">
            Bejelentkezés
          </a>
        </div>
